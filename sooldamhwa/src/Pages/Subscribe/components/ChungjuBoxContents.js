...
const ChungjuBoxContents = (props) => {
    ...
    return (
        <>
            <SubscribeLandingBox>
                <SubscribeLandingBoxBg id="DetailInfo" src="https://d38cxpfv0ljg7q.cloudfront.net/admin_contents/origin/48TP-1702000995031-PC_yakcheongju_back.jpg" />
                <LandingBox>
                    <LandingTotalBoxTitle>
                        <div>2024년 1월의 약·청주 담화박스</div>
                        맑은 술의 원조, 약·청주로만 <br />
                        구성된 담화박스
                    </LandingTotalBoxTitle>
                    <div>
                        <LandingBoxNameContents>
                            ...
                            <LandingBoxNameActive onClick={() => landingStateHandle("chungju")}>
                                <NameActiveImg src={chungju_subscription_icon} alt='약,청주' />약·청주</LandingBoxNameActive>
                        </LandingBoxNameContents>
                        <TotalBox>
                            <TotalBoxInpo>약·청주 담화박스</TotalBoxInpo>
                            <SubscribePrice>
                                ₩ 52,000/월
                                <span>₩ 55,000</span>
                            </SubscribePrice>
                            ...
                            <TotalBoxSubDescription>
                                인고의 시간 끝에 술을 맑게 걸러 탄생한 귀한 약·청주. <br />
                                깨끗함에 그윽이 배어있는 깊은 맛을 경험해 보세요.
                            </TotalBoxSubDescription>
...
const LandingBoxNameActive = styled.div`
    ...
    box-shadow: rgb(255, 125, 58) 0px 4px 0px inset;
...
export default ChungjuBoxContents;